...
export const RESOURCE_BREADCRUMB = "hal-op-resource-breadcrumb";
export const RESOURCE_HEADER = "hal-op-resource-header";
export const RESOURCE_TABS = "hal-op-resource-tabs";
