...
Fork https://github.com/hal/dave into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/dave.git
cd dave
```
...
```bash
git remote add upstream git://github.com/hal/dave.git
```
...
You also need [Podman](https://podman.io/) or [Docker](https://www.docker.com/) installed for running WildFly and halOP containers.

# Development Process

This is the typical process you would follow to submit any changes to dave.
